...
import 'package:fishinos/modelo/cidade.dart';
      ...
      body: FutureBuilder(
          ...
          builder: (BuildContext context, AsyncSnapshot<List> snapshot) {
            ...
            _controle.listaObjetosPesquisados = snapshot.data as List<
                Cidade>; //Carrega os dados retornados em uma lista (não futura) para ser mostrada na listview
